...
optimizer parameters. The learning rate of OCRopus and kraken can be specified by the user, while calamari and tesseract only support default learning rate. Tesseract is the only engine allows different layers to have different learning rate. All four engines allow the user to specify how long the
...
% CNN Layer                      &         & NA      & Yes    & Yes      & Yes       \\
\multirow{2}{*}{Learning Rate} & overall & \checkmark       & \checkmark      & -        &  -         \\
                               & layer   & -       & -      & -        & \checkmark         \\
\hline
