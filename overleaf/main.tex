...
% CN: Well, CER/WER is still most prominent in IAPR. Within
% READ/Transkribus apparently they also still use BoW/CER/WER:
% https://github.com/CITlabRostock/CITlabErrorRate. One could of
% course argue for the inclusion of ReadingOrder in the evaluation,
% for necessary normalizations of encodings, how to deal with (and
% which) stopwords, but I am not really aware of any concerted
% efforts in this direction. TBH, the whole claim that evaluation
% methods and metrics need updating is not entirely clear to me
% once I abandon the perspective that it is simply too cost- and
% time-intensive to produce large amounts of GT?
